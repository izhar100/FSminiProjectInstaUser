...
const Home = () => {
  return (
    <Box>
      <Heading color={"#bf00ff"} fontSize={"40px"} textAlign={"center"}>Welcome to insta Users</Heading>
      <br />
      <Flex margin={"auto"} justifyContent={"space-between"} gap={"40px"} w={"90%"}>
        <Box w={"33%"}>
        <Image src='https://api.backlinko.com/app/uploads/2020/08/instagram-users-post-banner.webp' w={"100%"} borderRadius={"5%"}/>
        </Box>
        <Box w={"33%"}>
        <Image src='https://media.sproutsocial.com/uploads/2022/04/Best-times-to-post-2022_BTTP-Instagram.jpg' w={"100%"} borderRadius={"5%"}/>
        </Box>
        <Box w={"33%"}>
        <Image src='https://adespresso.com/wp-content/uploads/2020/08/instagram-stats.jpg' w={"100%"} borderRadius={"5%"}/>
        </Box>
      </Flex>
      <br />
      <Heading color={"#bf00ff"} fontSize={"40px"} textAlign={"center"}>Our mission</Heading>
      <br />
      <Box w={"90%"} m={"auto"}>
